                ...
                <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; margin: 0; padding: 0; color: #2c3e50; background-color: white;">
                    <div style="width: 210mm; min-height: 297mm; margin: 0 auto; background-color: white; box-shadow: 0 0 20px rgba(0, 0, 0, 0.1); padding: 15mm;">
                        ...
                        <table style="width: 100%; border-collapse: collapse; margin-bottom: 30px;">
                            ...
                            ${
                              employee.EXAMES.length > 0 &&
                              employee.EXAMES.some(
                                (exame) => !exame.nomeExame.includes("eSocial"),
                              )
                                ? `<tr>
                                    <td colspan="3" style="padding: 10px; border: 1px solid #b2b2b2ff; font-size: 10px"">
                                        ...
                                        ${employee.EXAMES.filter(
                                          (exame) =>
                                            !exame.nomeExame.includes(
                                              "eSocial",
                                            ),
                                        )
                                          .map(
                                            (exame) =>
                                              `<span style="color:white; background-color:${secondaryColor}; border-radius: 50px; padding: 5px 10px; margin: 5px; white-space: nowrap; display: inline-block;">${exame.nomeExame}</span>`,
                                          )
                                          .join(" ")}
                                    </td>
                                </tr>`
